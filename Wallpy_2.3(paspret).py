...
class WallPy(QWidget):
    ...
    def updateLabels(self):
        ...
        if self.money <= 10 and self.possessed['petrol'] == 0 and self.possessed['iron'] == 0 and self.possessed['water'] == 0 and self.possessed['wood'] == 0 and self.possessed['coffee'] == 0 and self.possessed['wheat'] == 0 :
            QMessageBox.information(self, "Looser", "Wallpy Guard : Oh my Gosh !!! Return to school ! You need it !")
            self.close()
    def error(self):
    ...
    def mixPrice(self):
        ...
        if k == 1:
           self.prices['petrol'] += random.randint(1, 2)
           self.prices['iron'] += random.randint(1, 2)
           self.prices['water'] += random.randint(1, 2)
           self.prices['wood'] += random.randint(1, 2)
           self.prices['coffee'] += random.randint(1, 2)
           self.prices['wheat'] += random.randint(1, 2)
        elif k == 2:
           self.prices['petrol'] -= random.randint(1, 2)
           self.prices['iron'] -= random.randint(1, 2)
           self.prices['water'] -= random.randint(1, 2)
        ...
        if k1 == 1:
         if k == 1:
           self.prices['petrol'] += random.randint(1, 5)
           self.prices['iron'] += random.randint(1, 5)
           self.prices['water'] += random.randint(1, 5)
           self.prices['wood'] += random.randint(1, 5)
           self.prices['coffee'] += random.randint(1, 5)
           self.prices['wheat'] += random.randint(1, 5)
         elif k == 2:
           self.prices['petrol'] -= random.randint(1, 5)
           self.prices['iron'] -= random.randint(1, 5)
           self.prices['water'] -= random.randint(1, 5)
        ...
        if k2 == 1:
         if k == 1:
           self.prices['petrol'] += random.randint(1, 10)
           self.prices['iron'] += random.randint(1, 10)
           self.prices['water'] += random.randint(1, 10)
           self.prices['wood'] += random.randint(1, 10)
           self.prices['coffee'] += random.randint(1, 10)
           self.prices['wheat'] += random.randint(1, 10)
         elif k == 2:
           self.prices['petrol'] -= random.randint(1, 10)
           self.prices['iron'] -= random.randint(1, 10)
           self.prices['water'] -= random.randint(1, 10)
        ...
        if k3 == 1:
         if k == 1:
           self.prices['petrol'] += random.randint(1, 20)
           self.prices['iron'] += random.randint(1, 20)
           self.prices['water'] += random.randint(1, 20)
           self.prices['wood'] += random.randint(1, 20)
           self.prices['coffee'] += random.randint(1, 20)
           self.prices['wheat'] += random.randint(1, 20)
         elif k == 2:
           self.prices['petrol'] -= random.randint(1, 20)
           self.prices['iron'] -= random.randint(1, 20)
           self.prices['water'] -= random.randint(1, 20)
        ...
        if k4 == 1:
         if k == 1:
           ...
           self.prices['coffee'] -= random.randint(1, 50)
           self.prices['wheat'] -= random.randint(1, 50)
        k5 = random.randint(1, 10000)
        if k5 == 1:
         if k == 1:
           self.prices['petrol'] += random.randint(1, 100)
           self.prices['iron'] += random.randint(1, 100)
           self.prices['water'] += random.randint(1, 100)
           self.prices['wood'] += random.randint(1, 100)
           self.prices['coffee'] += random.randint(1, 100)
           self.prices['wheat'] += random.randint(1, 100)
         elif k == 2:
           self.prices['petrol'] -= random.randint(1, 100)
           self.prices['iron'] -= random.randint(1, 100)
           self.prices['water'] -= random.randint(1, 100)
